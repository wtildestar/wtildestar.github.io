...
$(function(){function e(){$(".carousel-works-item").each(function(){var e=$(this),s=e.find(".carousel-works-image").outerHeight();e.find(".carousel-works-image2").css("min-height",s)})}$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo-1.png" alt="Творческое агентство">'},offCanvas:{position:"right"}});var s=$("#my-menu").data("mmenu");s.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),s.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-main").owlCarousel({loop:!0,singleItem:!0,items:1,smartSpeed:700,nav:!1,dots:!0,responsiveClass:!0,responsive:{768:{items:1}}}),$(".carousel-works").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-works").owlCarousel({loop:!0,nav:!1,dots:!1,smartSpeed:700,responsiveClass:!0,responsive:{0:{items:2},800:{items:4},1100:{items:6}}}),$(".carousel-works-image").equalHeights(),e(),$(".carousel-works-image").equalHeights(),$(".comments").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"#",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},1500)}),!1})});